    ...
    setTimeout(() => {
        ...
        setTimeout(() => {
          send('Runtime.evaluate', {
              expression: 'document.querySelector("#payment-capture #payment-amount-input") ? "YES_INPUT" : document.querySelector("#payment-capture") ? document.querySelector("#payment-capture").outerHTML : "NO_CAPTURE_FORM"'
          });
        }, 4000);
    }, 4000);
  });
