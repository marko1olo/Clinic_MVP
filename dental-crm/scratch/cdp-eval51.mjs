  ...
  ws.on('open', () => {
    ...
    setTimeout(() => {
        ...
        setTimeout(() => {
          ...
          setTimeout(() => {
            send('Runtime.evaluate', {
              expression: '(() => { return { local: window.localStorage.getItem("dental-crm:web-ui-preferences:v1"), roleText: document.querySelector("details.workspace-role-switcher summary strong")?.innerText, documentHasRole: document.body.innerHTML.includes("Управляющий") || document.body.innerHTML.includes("Администратор") }; })()',
              returnByValue: true
            });
          }, 4000);
        }, 1000);
