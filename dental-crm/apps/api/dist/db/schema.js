import { boolean, foreignKey, index, integer, jsonb, numeric, pgEnum, pgTable, real, text, timestamp, unique, uuid, varchar, } from "drizzle-orm/pg-core";
...
export const patientAnamnesis = pgTable("patient_anamnesis", {
    ...
    systemicDiseases: jsonb("systemic_diseases").$type(),
...
export const migrationTemplates = pgTable("migration_templates", {
    ...
    mappingJson: jsonb("mapping_json").notNull().$type(),
...
export const denteWhatsappBotConfigs = pgTable("dente_whatsapp_bot_configs", {
    ...
    denteWhatsappBotConfigOrgUnique: unique("dente_whatsapp_bot_configs_org_unique").on(table.organizationId),
}));
export const denteMaxBotConfigs = pgTable("dente_max_bot_configs", {
    ...
    denteMaxBotConfigOrgUnique: unique("dente_max_bot_configs_org_unique").on(table.organizationId),
}));
