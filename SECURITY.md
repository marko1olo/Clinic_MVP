# 🔒 Security Policy — marko1olo/Clinic_MVP
...
> Project Scope: `Clinic MVP Full-Stack Clinical Diagnostics & Patient Portal`
...
We actively maintain and provide critical security updates for the following release lines of **marko1olo/Clinic_MVP**:
...
Security engineering in marko1olo/Clinic_MVP is guided by the following domain-specific threat vector analyses:

### 1. Unauthorized Patient Data Access
* **Description**: IDOR vulnerabilities allowing access to other patients' records.
...
### 2. Unsanitized Medical Notes
* **Description**: Stored XSS via clinical diagnosis input fields.
* **Impact Rating**: HIGH / CRITICAL
* **Mitigation Strategy**: Strict schema validation, boundary fuzz testing, and automated static security analysis.
...
If you discover a security flaw or exploit vector in **marko1olo/Clinic_MVP**, do **NOT** post it publicly in open issues or discussions.
