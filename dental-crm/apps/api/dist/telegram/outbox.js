...
export async function buildDenteTelegramOutboxItems(organizationId) {
    ...
    const tasks = await db
        ...
        .where(and(eq(communicationTasks.organizationId, organizationId), eq(communicationTasks.channel, "telegram"), or(eq(communicationTasks.status, "queued"), eq(communicationTasks.status, "scheduled"))));
