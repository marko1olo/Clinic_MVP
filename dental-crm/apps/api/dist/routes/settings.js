...
import { getClinicSettingsFromDb, getUiPreferencesFromDb, saveUiPreferencesInDb, stampedUiPreferencesSavedAt, UiPreferencesConcurrentSaveError, updateClinicModeInDb, updateClinicProfileInDb, createStaffMemberInDb, updateStaffWorkingHoursInDb, updateStaffCredentialsInDb, updateStaffMemberProfileInDb, deactivateStaffMemberInDb, createChairInDb, updateChairWorkingHoursInDb, updateChairProfileInDb, deactivateChairInDb, listDoctorCommissionRatesInDb, setDoctorCommissionRateInDb } from "../db/settingsQuery.js";
import { hashCredential } from "../utils/cryptoHelper.js";
import { chairSchema, clinicSettingsSchema, createChairSchema, createStaffMemberSchema, dentalSpecialtySchema, documentKindSchema, imagingStudyKindSchema, nonNegativeMoneyRubSchema, serviceCategorySchema, staffAuthorityStateSchema, staffMemberSchema, uiPreferencesInputSchema, uiPreferencesSchema, updateClinicModeSchema, updateClinicProfileSchema, updateChairWorkingHoursSchema, updateStaffAuthorityGrantsSchema, updateStaffWorkingHoursSchema, staffRoleSchema } from "@dental/shared";
...
export async function registerSettingsRoutes(app) {
    ...
    app.put("/api/settings/preferences", async (request, reply) => {
        ...
        const updated = { ...input, version: 1, savedAt: stampedUiPreferencesSavedAt(input.savedAt) };
        let outcome;
        try {
