  ...
  test('returns empty if assistant is required but not found', () => {
    const dashboard = {
      clinicSettings: {
        staff: [{
          id: 'doc1',
          workingHours: [{ enabled: true, weekday: 1, start: '09:00', end: '17:00' }]
        }],
        chairs: [{ id: 'chair1', name: 'Chair 1' }]
      },
      appointments: []
      ...
      clinicSettings: {
        staff: [
          ...
          },
          {
            ...
            workingHours: [{ enabled: true, weekday: 2, start: '09:00', end: '17:00' }]
          }
        ],
        chairs: [{
          id: 'chair1',
  ...
  test('returns available slots avoiding collisions and skipped for canceled appointments', () => {
    ...
    const dashboard = {
      clinicSettings: {
        staff: [{
          id: 'doc1',
          workingHours: [{ enabled: true, weekday: 1, start: '09:00', end: '11:00' }]
        }],
        chairs: [{
          id: 'chair1',
          workingHours: [{ enabled: true, weekday: 1, start: '09:00', end: '11:00' }]
