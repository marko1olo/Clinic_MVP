...
export function useVoiceAssistant(
  ...
  const processAudioOnServer = useCallback(async (audioBlob: Blob) => {
    try {
  ...
  }, [isListening, updateVolume, speechGatewayStatus, startBrowserNative, processAudioOnServer, playBeep]);
