...
export const dicomWorkbenchBundles = pgTable("dicom_workbench_bundles", {
    ...
    sourceName: text("source_name").notNull(),
    sourceKind: imagingSourceKind("source_kind").notNull(),
    pixelPolicy: text("pixel_policy").$type().notNull().default("metadata_and_tool_state_only_no_pixels"),
...
export const migrationReconciliations = pgTable("migration_reconciliations", {
    ...
    checksJson: jsonb("checks_json").$type().notNull(),
    entityBreakdownJson: jsonb("entity_breakdown_json").$type().notNull(),
    /*
