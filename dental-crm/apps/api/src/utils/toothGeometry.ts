...
export const getToothPath = (toothId: number): typeof TOOTH_GEOMETRY[keyof typeof TOOTH_GEOMETRY] => {
...
export const getToothConfig = (toothId: number) => {
  ...
  if (num <= 2) return { width: 36, height: 56, viewWidth: 100, viewHeight: 150 };
  if (num === 3) return { width: 40, height: 64, viewWidth: 100, viewHeight: 150 };
  if (num <= 5) return { width: 44, height: 70, viewWidth: 100, viewHeight: 150 };
