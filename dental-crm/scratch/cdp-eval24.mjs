    ...
    setTimeout(() => {
        ...
        setTimeout(() => {
          send('Runtime.evaluate', {
              expression: '(() => { const el = document.querySelector("#finance.finance-panel"); if (el) return "YES_FINANCE"; return document.querySelector("main") ? document.querySelector("main").className : "NO_MAIN"; })()'
          });
        }, 4000);
    }, 4000);
  });
