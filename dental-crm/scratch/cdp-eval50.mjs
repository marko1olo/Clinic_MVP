  ...
  ws.on('open', () => {
    ...
    setTimeout(() => {
        ...
        setTimeout(() => {
          ...
          setTimeout(() => {
            send('Runtime.evaluate', {
              expression: '(() => { return { currentViewClass: document.querySelector("#workspace-content")?.className, financePanel: !!document.querySelector("#finance.finance-panel"), errorBoundary: document.querySelector(".app-error-boundary")?.innerText, financePanelInner: document.querySelector("#finance.finance-panel")?.innerHTML, roleText: document.querySelector("details.workspace-role-switcher summary strong")?.innerText, shiftView: !!document.querySelector(".shift-intelligence") }; })()',
              returnByValue: true
            });
          }, 4000);
        }, 1000);
