...
import inject_old_data as inject_module
...
class TestInjectOldData(unittest.TestCase):
    def setUp(self):
        ...
        self.original_db_file_database = database_module.DB_FILE
        self.original_db_file_inject = inject_module.DB_FILE

        # Point the database to the temporary file
        database_module.DB_FILE = self.db_path
        inject_module.DB_FILE = self.db_path
    ...
    def tearDown(self):
        ...
        database_module.DB_FILE = self.original_db_file_database
        inject_module.DB_FILE = self.original_db_file_inject
