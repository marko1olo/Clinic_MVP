  ...
  ws.on('open', () => {
    ...
    setTimeout(() => {
        ...
        setTimeout(() => {
          ...
          setTimeout(() => {
            send('Runtime.evaluate', {
              expression: '(() => { const err = document.querySelector(".app-error-boundary") ? document.querySelector(".app-error-boundary").innerHTML.substring(0, 500) : "NO_ERROR"; return err; })()'
            });
          }, 1000);
        }, 4000);
    }, 4000);
