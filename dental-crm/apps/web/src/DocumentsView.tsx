...
export function DocumentsView(props: DocumentsViewProps) {
	...
	useEffect(() => {
		...
		if (previousPatientId === null || previousPatientId === openedPatientId)
			return;
				...
				>
					...
					>
						<div style={{ display: "flex", alignItems: "center", gap: "8px" }}>
							...
							/>
							<span>
								Откройте HTML и проверьте пациента, реквизиты, подписи и
								основание выдачи.
							</span>
						</div>
						<div style={{ display: "flex", alignItems: "center", gap: "8px" }}>
				...
				>
					...
					>
						<div style={{ display: "flex", alignItems: "center", gap: "8px" }}>
							...
							/>
							<span>
								Запись останется в журнале, архивная копия не удаляется.
							</span>
						</div>
						<div style={{ display: "flex", alignItems: "center", gap: "8px" }}>
							<span
				...
				>
					...
					<div className="document-audit-facts-grid">
						...
						<div>
							...
							<small>
								{documentAuditFacts.sourceReference} · форма сверена с
