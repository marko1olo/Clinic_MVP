...
def generate_seo_response(review_text: str) -> str:
    ...
    phone_instruction = f" по телефону {clinic_phone}" if clinic_phone else ""
...
- Переведи диалог в конструктивное русло: попроси связаться с главным врачом клиники{phone_instruction} для разбора клинического случая и решения проблемы.
