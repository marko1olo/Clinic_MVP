  ...
  ws.on('open', () => {
    ...
    setTimeout(() => {
        ...
        setTimeout(() => {
          ...
          setTimeout(() => {
            send('Runtime.evaluate', {
              expression: '(() => { const err = document.querySelector("#finance.finance-panel") ? "YES_FINANCE" : document.querySelector("#root") ? document.querySelector("#root").innerHTML.substring(1500, 3000) : "NO_ROOT"; return err; })()'
            });
          }, 4000);
        }, 1000);
    }, 4000);
