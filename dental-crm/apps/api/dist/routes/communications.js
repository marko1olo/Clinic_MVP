...
import { communicationEvents, communicationTasks, organizations, patients, } from "../db/schema.js";
import { wsBroker } from "../services/websocketBroker.js";
const communicationTaskValidationMessage = "Ошибка задачи: поля не прошли валидацию.";
const communicationTaskNotFoundMessage = "Ошибка задачи: задача не найдена или уже недоступна.";
