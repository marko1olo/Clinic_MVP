...
def generate_seo_response(review_text: str) -> str:
    ...
    clinic_phone = os.getenv("CLINIC_PHONE", "+7 (846) 222-33-44") # Hardcoded phone from guidelines: "The main clinic modeled in the system is 'DENTE', located in Samara, and references the contact phone number +7 (846) 222-33-44 in hardcoded SEO agent prompts and mock contracts."
